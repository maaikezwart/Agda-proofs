...
module combinations-of-lift-and-exception where
...
--**************************************************************************--
--**************************************************************************--
-- Combining the monads Lift and Exception freely and via a distributive law --
--**************************************************************************--
--**************************************************************************--

-- In this document I want to define a monad, called ExceptLift, that is the free combination of the Lift monad and the Exception monad.
...
-- unit, bind and multiplication functions for Exception
unitE : {A E : Set} → A → Exception A E
unitE a = inl a

bindE : {A B E : Set} → (A → Exception B E) → Exception A E → Exception B E
bindE f (inl a) = f a
bindE f (inr e) = inr e
...
--**********************--
-- The ExceptLift monad --
--**********************--

--Now that we have a Exception monad and a Lift monad, I want to show that the following combination of the two is again a monad:
